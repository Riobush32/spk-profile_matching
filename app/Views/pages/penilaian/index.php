        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <div class="flex gap-3 w-full justify-center items-center">
                    <form id="deleteForm" action="/penilaian/delete" method="POST">
                        <?= csrf_field() ?>
...
const kriteriaHeaders = <?= json_encode(array_map(fn($kri) => $kri['nama_kriteria'], $kriteria)); ?>;

const headings = ['Alternatif', ...kriteriaHeaders.map(header => header.replace(' ', '\n')), 'Actions'];
