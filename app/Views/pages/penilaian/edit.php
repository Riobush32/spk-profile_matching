...
<div class="w-full flex justify-start items-center ">
    <form action="/penilaian/update/<?=$penilaian[0]['alternative_id']?>" method="post"
        ...
        <div class="max-w-96">
            ...
            <select id="small" name="alternative" required
                ...
                <option value="<?=$penilaian[0]['alternative_id']?>">
                    <?=$penilaian[0]['nama_alternative']?></option>
            </select>
        </div>
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="mt-3 ">
                ...
                <select id="small" name="subkriteria_<?=$row['id']?>" required
                    ...
                    <option value="<?=$penilaian[$key]['sub_kriteria_id']?>"><?=$penilaian[$key]['nama_kriteria']?> →
                        <?=$penilaian[$key]['nama_subkriteria']?> = <?=$penilaian[$key]['nilai']?></option>
                    <?php 
                    $id = $row['id'];
                ...
                ?>
                    <option value="<?=$item['id']?>"><strong><?=$item['nama_kriteria']?></strong> →
