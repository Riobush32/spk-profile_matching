<div
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table
            ...
            <tbody>
                <?php foreach($hasil_selisih as $selisih): ?>
                <tr
                    ...
                    <th scope="row"
                        class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white print:text-black group-hover:text-amber-300">
                        <?=$selisih['alternative']?>
                    </th>
                    <?php foreach($selisih['selisih'] as $value): ?>
                    <td class="px-6 py-4 group-hover:text-amber-300 print:text-black">
                        <?=$value?>
                    </td>
                    <?php endforeach; ?>
                </tr>
