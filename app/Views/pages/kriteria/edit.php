    ...
    <form action="/kriteria/update/<?=$kriteria['id']?>" method="POST"
        ...
        <div>
            <label for="small-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama
                Kriteria</label>
            <input type="text" id="small-input" name="nama_kriteria" required autofocus
        ...
        <div class="mt-3">
            <label for="small" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jenis
                Kriteria</label>
            <select id="small" name="jenis_kriteria" required
                ...
                <option selected value="<?=$kriteria['jenis_kriteria']?>"><?=$kriteria['jenis_kriteria']?></option>
